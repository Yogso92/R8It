...
namespace DB
{
    public class Command
    {
        ...
        public void SetParameters<T>(object o) //WIP: T = attributs de propriétés à ne pas rajouter aux params 
        ...
        public void SetParameters(object o) //ajoute tous les parametres selon les propriétés de l'objet
        {
            List<PropertyInfo> properties = o.GetType().GetProperties().ToList<PropertyInfo>();
            PropertyInfo[] removables = new object().GetType().GetProperties();
            foreach (PropertyInfo rem in removables)
